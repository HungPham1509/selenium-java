...
public class InstagramElements {
    public static final String instagramLoginUrl = "https://www.instagram.com/accounts/login/?source=auth_switcher";
    public static final By notNowButton = By.className("HoLwm");
    ...
    public static final By searchResult = By.className("yCE8d");
    public static final By searhName = By.className("Ap253");
}
